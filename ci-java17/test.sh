#!/usr/bin/env bash
# Smoke tests for the ci-java17 image. Run against a built image before it is pushed.
#   ./ci-java17/test.sh ci-java17:test
#
...
check "java is 17"                 'java --version | head -1 | grep -q " 17\."'
