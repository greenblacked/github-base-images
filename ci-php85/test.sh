#!/usr/bin/env bash
# Smoke tests for the ci-php85 image. Run against a built image before it is pushed.
#   ./ci-php85/test.sh ci-php85:test
#
...
check "php is 8.5"                 'php -r "exit(version_compare(PHP_VERSION, \"8.5\", \">=\") && version_compare(PHP_VERSION, \"8.6\", \"<\") ? 0 : 1);"'
